...
### [settings-manager.js](../src/utils/setting-manager.js)
- 改造 settings 存储方式，并支持 nativeTheme。

### [window-manager.js](../src/utils/window-manager.js)
- 模态窗口出问题了。请检查。

### utils 和 public components 应该分开来
- 目前 utils 和 public components 都放在一起，应该分开来。
- utils 放一些工具类，public components 放一些公共组件。
